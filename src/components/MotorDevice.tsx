...
import { MotorData, convertMotorProcessToString, convertMotorStateToColor, convertMotorStateToString } from '@/types/motor';
...
const MotorDevice: React.FC<MotorDeviceProps> = ({ motorData, name }) => {
    ...
    return (
      <div className="rounded-lg bg-black text-white p-3 w-64 h-54">
